                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="reports-subconty-zones.html">Collection Zones</a></li>
                                        <li class="breadcrumb-item active">Selected Zone</li>
                                    </ol>
                                </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header bg-white d-flex justify-content-between align-items-center w-100 border-bottom p-3">
                                    <div>
                                        <h4 class="card-title">{{zone}} Collections for {{subCountyName}}</h4>
                                    </div>
                                    <div>
                                        <select class="form-select w-auto font-13px" v-model="zone">
                                            <option v-for="(item, index) in zones" :value="item.zone" :key="index">
                                                {{item.zone}} ({{numberFormat(item.count)}})</option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="btn-toolbar p-3 d-flex justify-content-between align-items-center w-100" role="toolbar">
                                      <div class="flex-grow-1">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <button @click="downloadReceiptsPaginated()"  data-bs-toggle="modal" data-bs-target=".download-modal" type="button" class="btn btn-primary dropdown-toggle option-selector me-3 text-capitalize">
...
<script>
    ...
    export default {
        name: "ReportsSubCountyZonesDetails",
...
// return the array of pages
            ...
            getZones() {
                const data = new FormData();
                data.append("function", "getReceiptedByZonesPaginated");
                data.append("page", this.currentPage);
                ...
                execute(data, biller)
                    .then((res) => {
                        this.zones = res.data.data.revenueZones
            ...
            downloadReceiptsPaginated(){
                const data = new FormData();
                data.append("function", "downloadReceiptsPaginated");
                data.append("page", this.currentPage);
                data.append("rows_per_page", this.pageSize);
                data.append("status", "PAID");
                data.append("dateFrom", this.dateFrom);
                ...
                executeDownload(data,biller).then(response => {
                    ...
                    link.download = this.dateFrom+' to '+ this.dateTo+' '+ this.search+' '+this.zone+" transactions.csv";
