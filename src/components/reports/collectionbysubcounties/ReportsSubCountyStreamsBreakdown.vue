                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">Collections For {{subCountyName}} for the period {{formatDate(dateFrom)}} to {{formatDate(dateTo)}}</h4>
                                        ...
                                        <table class="table align-middle table-hover  contacts-table table-striped " id="">
                                            ...
                                            <tr v-for="(item, index) in revenueStreams" :value="item" :key="index">
                                                ...
                                                <td class="text-capitalize text-nowrap">
                                                    <a @click="gotTo('reports-sub-county-streams-details',item.incomeTypeDescription,item.feeDescription)" href="javascript:void(0)">{{item.incomeTypeDescription}} <small>{{item.feeDescription}}</small></a>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-end">
                                                        <a type="button" @click="gotTo('reports-sub-county-streams-details',item.incomeTypeDescription,item.feeDescription)" href="javascript:void(0)" class="btn btn-primary btn-sm waves-effect waves-light text-nowrap me-3">View Details</a>
                                                        <div class="dropdown">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                loading: false,
                // set the ainitial current page as 1
                currentPage: 1,
        ...
        watch: {
            ...
            pageSize(newPageSize) {
                this.getReceiptedByRevenueStreamBreakDownPaginated()//Todo to change here
            ...
            search(){
                this.getReceiptedByRevenueStreamBreakDownPaginated()
            },
...
// return the array of pages
            ...
            prevPage() {
                ...
                if (this.currentPage > 1) {
                    ...
                    this.currentPage--;
                    this.getReceiptedByRevenueStreamBreakDownPaginated()//Todo change
                }
            },
            ...
            getReceiptedByRevenueStreamBreakDownPaginated() {
                this.revenueStreams.splice(0)
                this.loading = true
                const data = new FormData();
                data.append("function", "getReceiptedByRevenueStreamBreakDownPaginated");
